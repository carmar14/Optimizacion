...
MAKECMD         = "C:/ARCHIV~1/MATLAB/R2012a/bin/win32/gmake"
HOST            = PC
BUILD           = yes
...
MODEL                := ControladorContinuo
MODULES              := ControladorContinuo_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := ControladorContinuo.mk
MATLAB_ROOT          := C:/ARCHIV~1/MATLAB/R2012a
MATLAB_BIN           := C:/ARCHIV~1/MATLAB/R2012a/bin
S_FUNCTIONS          := 
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
...
RTWINDIR             := C:/ARCHIV~1/MATLAB/R2012a/toolbox/rtw/targets/rtwin
TARGETARCH           := win32
CC_LISTING           := 0
REBUILD_ALL          := 1
...
#
MODELLIB                  := ControladorContinuolib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := ControladorContinuo_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);E:/8SEMES~1/PROYEC~1/ControladorContinuo_rtwin_win32;E:/8SEMES~1/PROYEC~1
