function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model ControladorContinuo
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	E:\8 Semestre\Proyecto final control 2\ControladorContinuo_rtwin_win32\ControladorContinuo.rtw
% 	C:\Archivos de programa\MATLAB\R2012a\toolbox\rtw\targets\rtwin\rtwin\rtwin.tlc
% 	-OE:\8 Semestre\Proyecto final control 2\ControladorContinuo_rtwin_win32
% 	-IC:\Archivos de programa\MATLAB\R2012a\toolbox\rtw\targets\rtwin\rtwin
% 	-IC:\Archivos de programa\MATLAB\R2012a\toolbox\rtw\targets\rtwin\rtwin
% 	-IE:\8 Semestre\Proyecto final control 2\ControladorContinuo_rtwin_win32\tlc
...
% 	-p10000
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', 'E:\8 Semestre\Proyecto final control 2\ControladorContinuo_rtwin_win32');
      rtwprivate('ec_set_replacement_flag', 'ControladorContinuo');
      load tlccmd.mat;
      savedpwd = pwd;
      cd ..;
