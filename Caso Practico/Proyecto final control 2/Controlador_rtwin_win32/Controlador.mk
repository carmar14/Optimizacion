...
MODEL                := Controlador
MODULES              := Controlador_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := Controlador.mk
...
#
MODELLIB                  := Controladorlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := Controlador_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);E:/8SEMES~1/PROYEC~1/Controlador_rtwin_win32;E:/8SEMES~1/PROYEC~1
